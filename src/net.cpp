...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitmxittz " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitmxittztools.com", "52.192.16.19"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bitmxittztools.com", "testnet-seed.bitmxittztools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitmxittz is probably already running."), addrBind.ToString().c_str());
        else
